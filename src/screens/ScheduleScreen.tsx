...
export const ScheduleScreen: React.FC<ScheduleScreenProps> = ({ navigation }) => {
  const { notificationTime, setNotificationTime, setWantsQuotes } = usePreferences();
  ...
  return (
    <ScreenContainer>
      <GlassCard>
        ...
        <Text style={styles.subtitle}>בחר זמן קבוע ביום שבו תופיע התראה עם ציטוט חדש.</Text>
        {Platform.OS === 'android' ? (
